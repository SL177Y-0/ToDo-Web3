...
export declare namespace EnhancedTodoList {
...
export interface EnhancedTodoListInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "completeTask"
      | "createTask"
  ...
  encodeFunctionData(
    functionFragment: "getTaskMetadata",
  ...
  encodeFunctionData(
    functionFragment: "setTaskMetadata",
...
export interface EnhancedTodoList extends BaseContract {
  connect(runner?: ContractRunner | null): EnhancedTodoList;
  waitForDeployment(): Promise<this>;

  interface: EnhancedTodoListInterface;
  ...
  getTask: TypedContractMethod<
    [_taskId: BytesLike],
    [EnhancedTodoList.TaskStructOutput],
    "view"
  >;

  getTaskMetadata: TypedContractMethod<
    [_taskId: BytesLike, _key: BytesLike],
    [boolean],
    "view"
  >;
  ...
  setTaskMetadata: TypedContractMethod<
    [_taskId: BytesLike, _key: BytesLike, _value: boolean],
    [void],
    "nonpayable"
  >;
  ...
  >;
  getFunction(
    nameOrSignature: "getTaskMetadata"
  ): TypedContractMethod<
    [_taskId: BytesLike, _key: BytesLike],
    [boolean],
    "view"
  ...
  getFunction(
    nameOrSignature: "setTaskMetadata"
  ): TypedContractMethod<
    [_taskId: BytesLike, _key: BytesLike, _value: boolean],
    [void],
    "nonpayable"
